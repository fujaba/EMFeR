 ...
 * @generated
 */
public class FerrymanSwitch<T> extends Switch<T>
{
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject)
   {
      switch (classifierID)
      {
         case FerrymanPackage.RIVER:
         {
            River river = (River)theEObject;
            T result = caseRiver(river);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case FerrymanPackage.BANK:
         {
         ...
         case FerrymanPackage.BOAT:
         {
            Boat boat = (Boat)theEObject;
            T result = caseBoat(boat);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case FerrymanPackage.CARGO:
         {
   ...
   /**
    * Returns the result of interpreting the object as an instance of '<em>River</em>'.
    * <!-- begin-user-doc -->
    * This implementation returns null;
    * returning a non-null result will terminate the switch.
    * <!-- end-user-doc -->
    * @param object the target of the switch.
    * @return the result of interpreting the object as an instance of '<em>River</em>'.
    * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
    * @generated
    */
   public T caseRiver(River object)
   {
      return null;
   }
   ...
   /**
    * Returns the result of interpreting the object as an instance of '<em>Boat</em>'.
    * <!-- begin-user-doc -->
    * This implementation returns null;
    * returning a non-null result will terminate the switch.
    * <!-- end-user-doc -->
    * @param object the target of the switch.
    * @return the result of interpreting the object as an instance of '<em>Boat</em>'.
    * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
    * @generated
    */
   public T caseBoat(Boat object)
   {
      return null;
   }

 ...
 * @generated
 */
public class TowerAdapterFactory extends AdapterFactoryImpl
{
   /**
    ...
    * @generated
    */
   protected TowerSwitch<Adapter> modelSwitch =
      new TowerSwitch<Adapter>()
      {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link emfer.examples.tower.Board <em>Board</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link emfer.examples.tower.Stack <em>Stack</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link emfer.examples.tower.Disc <em>Disc</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
